...
const STATUT_COLORS: Record<string, string> = {
  ...
  envoye: "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border border-blue-300 dark:border-blue-700",
  repondu: "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 border border-emerald-300 dark:border-emerald-700",
  incomplet: "bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 border border-amber-300 dark:border-amber-700",
};
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Questionnaires d&apos;adaptation pedagogique envoyes aux clients et stagiaires avant formation</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{repondusClient}/{totalClient}</p>
              <p className="text-xs text-gray-600 dark:text-gray-400">Fiches client repondues</p>
            </div>
          </div>
        </div>
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{repondusStagiaire}/{totalStagiaire}</p>
              <p className="text-xs text-gray-600 dark:text-gray-400">Fiches stagiaire repondues</p>
            </div>
          </div>
        </div>
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{rqthCount}</p>
              <p className="text-xs text-gray-600 dark:text-gray-400">Stagiaires RQTH identifies</p>
            </div>
          </div>
        </div>
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{totalClient + totalStagiaire - repondusClient - repondusStagiaire}</p>
              <p className="text-xs text-gray-600 dark:text-gray-400">En attente de reponse</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 mb-4">
        <nav className="flex gap-1">
          <button
            ...
            className={`flex items-center gap-2 px-4 pb-3 pt-1 text-sm font-medium border-b-2 transition-colors ${tab === "client" ? "border-red-600 text-red-500" : "border-transparent text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300"}`}
          >
            <Building2 className="h-4 w-4" /> Fiches Client
            <span className="ml-1 inline-flex items-center justify-center h-5 min-w-[20px] rounded-full bg-gray-100 dark:bg-gray-700 px-1.5 text-[11px] font-medium text-gray-700 dark:text-gray-300">{totalClient}</span>
          </button>
          <button
            onClick={() => setTab("stagiaire")}
            className={`flex items-center gap-2 px-4 pb-3 pt-1 text-sm font-medium border-b-2 transition-colors ${tab === "stagiaire" ? "border-red-600 text-red-500" : "border-transparent text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300"}`}
          >
            <User className="h-4 w-4" /> Fiches Stagiaire
            <span className="ml-1 inline-flex items-center justify-center h-5 min-w-[20px] rounded-full bg-gray-100 dark:bg-gray-700 px-1.5 text-[11px] font-medium text-gray-700 dark:text-gray-300">{totalStagiaire}</span>
          </button>
        </nav>
      </div>
      ...
      <div className="flex items-center gap-3 mb-4">
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full h-10 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 pl-9 pr-3 text-sm text-gray-800 dark:text-gray-200 focus:outline-none focus:border-red-500"
          />
        </div>
        <select
          value={statutFilter}
          onChange={(e) => setStatutFilter(e.target.value)}
          className="h-10 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 text-sm text-gray-800 dark:text-gray-200"
        >
  ...
  if (fiches.length === 0) {
    return (
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl py-16 text-center">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">Aucune fiche client</p>
      ...
      <table className="w-full text-sm">
        <thead className="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
          <tr>
            ...
            <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">Destinataire</th>
            <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">Formation / Session</th>
            <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">Secteur</th>
            <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">Envoi</th>
            <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">Reponse</th>
        ...
        <tbody>
          {fiches.map((f) => (
            <tr key={f.id} className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-750">
              ...
              <td className="px-4 py-3 text-gray-600 dark:text-gray-400 text-xs">{f.dateReponse ? formatDate(f.dateReponse) : "—"}</td>
              <td className="px-4 py-3">
                <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${STATUT_COLORS[f.statut] ?? "bg-gray-100 dark:bg-gray-700"}`}>
                  {STATUT_LABELS[f.statut] ?? f.statut}
                </span>
                {f.optionnel && <span className="ml-1 text-[10px] text-amber-700 dark:text-amber-400">(optionnel)</span>}
              </td>
              <td className="px-4 py-3">
                <div className="flex items-center justify-end gap-1">
                  <button onClick={() => onCopy(f.tokenAcces)} className="inline-flex items-center gap-1 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-2 py-1 text-xs text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:bg-gray-700" title="Copier le lien">
                    <Copy className="h-3 w-3" /> {copiedToken === f.tokenAcces ? "Copie!" : "Lien"}
                  </button>
                  <Link href={`/qualiopi/fiche-entreprise/${f.tokenAcces}`} target="_blank" className="inline-flex items-center gap-1 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-2 py-1 text-xs text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:bg-gray-700" title="Ouvrir le formulaire">
  ...
  if (fiches.length === 0) {
    return (
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl py-16 text-center">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">Aucune fiche stagiaire</p>
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
      <table className="w-full text-sm">
        <thead className="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
          <tr>
            <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">Stagiaire</th>
            <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">Email</th>
            <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">Envoi</th>
            <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">Reponse</th>
            <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">RQTH</th>
            <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">Statut</th>
            <th className="px-4 py-3 text-right font-medium text-gray-600 dark:text-gray-400">Actions</th>
          </tr>
        </thead>
        <tbody>
          {fiches.map((f) => (
            <tr key={f.id} className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-750">
              ...
              <td className="px-4 py-3 text-gray-600 dark:text-gray-400 text-xs">{f.contact.email}</td>
              <td className="px-4 py-3 text-gray-600 dark:text-gray-400 text-xs">{f.dateEnvoi ? formatDate(f.dateEnvoi) : "—"}</td>
              <td className="px-4 py-3 text-gray-600 dark:text-gray-400 text-xs">{f.dateReponse ? formatDate(f.dateReponse) : "—"}</td>
              <td className="px-4 py-3">
                {f.estRQTH ? (
                  <span className="inline-flex items-center gap-1 rounded-full bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400 border border-orange-300 dark:border-orange-700 px-2 py-0.5 text-xs font-medium">
              ...
              <td className="px-4 py-3">
                <div className="flex items-center justify-end gap-1">
                  ...
                  <Link href={`/qualiopi/fiche-stagiaire/${f.tokenAcces}`} target="_blank" className="inline-flex items-center gap-1 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-2 py-1 text-xs text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:bg-gray-700" title="Ouvrir le formulaire">
                    <ExternalLink className="h-3 w-3" />
                  </Link>
                  {f.contact.email && (
                    <button onClick={() => onResend(f.id)} className="inline-flex items-center gap-1 rounded-md bg-red-600 hover:bg-red-700 px-2 py-1 text-xs text-white" title="Renvoyer l'email">
