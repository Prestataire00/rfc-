  ...
  if (error || !formateur) {
    return (
      <div className="p-6">
        ...
        <Link href="/formateurs" className="text-blue-600 hover:underline text-sm mt-2 inline-block">
            ...
            <CardContent className="space-y-3">
              {formateur.email && (
                <div className="flex items-center gap-3">
                  ...
                  <a href={`mailto:${formateur.email}`} className="text-sm text-blue-600 hover:underline">
                    {formateur.email}
                  </a>
                </div>
              )}
              {formateur.telephone && (
                <div className="flex items-center gap-3">
                  ...
                  <a href={`tel:${formateur.telephone}`} className="text-sm text-gray-700 hover:underline">
                    {formateur.telephone}
                  </a>
                </div>
              )}
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <Card>
                <CardContent className="pt-4 text-center">
                  <div className="text-2xl font-bold text-blue-600">{sessionsAVenir.length}</div>
                  <div className="text-xs text-gray-500 mt-1">Session{sessionsAVenir.length !== 1 ? "s" : ""} à venir</div>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-4 text-center">
                  <div className="text-2xl font-bold text-green-600">{sessionsPassees.length}</div>
                  <div className="text-xs text-gray-500 mt-1">Session{sessionsPassees.length !== 1 ? "s" : ""} passée{sessionsPassees.length !== 1 ? "s" : ""}</div>
                </CardContent>
              </Card>
            </div>
            ...
            {formateur.notes && (
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-gray-700 whitespace-pre-wrap">{formateur.notes}</p>
                </CardContent>
              </Card>
            )}
          </div>
          ...
          {formateur.sessions.length === 0 && (
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-sm text-gray-500">Aucune session assignée</p>
              </div>
            </div>
          )}
        </div>
