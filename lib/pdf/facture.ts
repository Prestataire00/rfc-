...
export function facturePdf(data: {
  ...
  societe?: {
    ...
    // Conformité légale (mêmes champs que devis — cf. Parametres) :
  ...
  notes?: string;
  devisNumero?: string;
  // Sessions liées : reprise dans la section « Délais d'exécution »
  ...
  // Ventilation TVA multi-taux (art. 289 II CGI).
  ...
  return {
    ...
    content: [
      ...
      // ── DÉLAIS D'EXÉCUTION (si sessions liées) — art. L111-1 C.conso ──
        ...
        columns: [
          {
            ...
            stack: [
              ...
              // Mentions B2B obligatoires (art. L441-10 + D441-5 C.com)
              ...
              // Mention TVA légale si exonéré / franchise
