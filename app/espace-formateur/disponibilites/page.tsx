      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="rounded-lg border bg-white p-6 mb-6 space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <button type="button" onClick={() => setShowForm(false)} className="rounded-md border px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
              Annuler
            </button>
          </div>
        </form>
        ...
        <div className="rounded-lg border bg-white overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b">
              <tr>
                <th className="text-left px-4 py-3 font-medium text-gray-600">Date debut</th>
              ...
              {dispos.map((d) => (
                <tr key={d.id} className="border-b last:border-0">
                  ...
                  <td className="px-4 py-3">
                    <span className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${d.type === "disponible" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}>
