...
export default function CatalogueClient({ formations, categories }: Props) {
  ...
  const filtered = useMemo(() => {
    return formations.filter((f) => {
      ...
      if (filterModalite && f.modalite !== filterModalite) return false;
      return true;
    });
  }, [formations, filterCat, filterModalite]);
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="h-9 rounded-md border border-gray-700 bg-gray-800 text-sm text-gray-200 px-3"
            >
