...
export default function NouvelleFormationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (form.publicCible) payload.publicCible = form.publicCible;
      if (form.contenuProgramme) payload.contenuProgramme = form.contenuProgramme;
      if (form.methodesPedagogiques) payload.methodesPedagogiques = form.methodesPedagogiques;
      if (form.methodesEvaluation) payload.methodesEvaluation = form.methodesEvaluation;
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-100">Nouvelle formation</h1>
        <p className="text-sm text-gray-400 mt-1">Ajoutez une nouvelle formation à votre catalogue</p>
      </div>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                onChange={handleChange}
                placeholder="Formation accessible aux personnes en situation de handicap. Contactez-nous pour adapter les conditions..."
                rows={2}
              />
            </div>
            <div className="space-y-1.5">
