  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Nouveau formateur</h1>
        <p className="text-sm text-gray-500 mt-1">Ajoutez un nouveau formateur à votre équipe</p>
      </div>
