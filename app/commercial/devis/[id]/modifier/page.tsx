    ...
    <div className="max-w-3xl mx-auto">
      <div className="mb-6">
        <Breadcrumb items={[
          ...
          { label: "Devis", href: `/commercial/devis/${id}` },
          { label: "Modifier" },
        ]} />
        <h1 className="text-2xl font-bold text-gray-100">Modifier le devis</h1>
        <p className="text-gray-400">Mettez à jour les informations du devis</p>
      </div>
